...
function Domainwall_wizard!(system)
    ...
    N5 =
        parse(Int64, Base.prompt("Input the size of the extra dimension N5", default = "4"))
    wilson["Domainwall_N5"] = N5

    wtype = request(
        "Choose domain wall fermion type",
        RadioMenu([
    ...
    if wtype == 1
        ...
        error(
            "Not implemented yet. Now only standard domainwall fermion can be used. Try again.",
        )
