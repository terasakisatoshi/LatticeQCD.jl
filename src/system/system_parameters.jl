...
printlist_HMCrelated =
    ["Δτ", "SextonWeingargten", "N_SextonWeingargten", "MDsteps", "eps", "MaxCGstep"]
# Action parameter for SLMC
printlist_parameters_SLMC = [
    "βeff",
    "firstlearn",
    "use_autogeneratedstaples",
    "couplingcoeff",
    "couplinglist",
    "coupling_loops",
]
...
struct Params
    ...
    function Params(system, actions, md, cg, wilson, staggered, measurement)
        ...
        if use_autogeneratedstaples
            ...
            if haskey(actions, "coupling_loops")
                ...
                error(
                    "actions[\"coupuling_loops\"] should be set if actions[\"use_autogeneratedstaples\"] is true",
                )
            end
        ...
        elseif update_method == "Heatbath"
            ...
            if system["quench"] == false
                error(
                    "system[\"quench\"] = false. The Heatbath method needs the quench update. Put the other system[\"update_method\"] != \"Heatbath\" or system[\"quench\"] = true",
                )
            end
    ...
    function Params(params_set::Params_set)
        return Params(
            ...
            params_set.cg,
            params_set.wilson,
            params_set.staggered,
            params_set.measurement,
        )
    end
